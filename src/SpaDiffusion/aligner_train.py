...
from .graph_align import SpaDiffusion_Aligner

cudnn.deterministic = True
cudnn.benchmark = True


def train_spatial_aligner(adata, hidden_dims=[512, 256], num_epochs=1000, learning_rate=0.001, output_key='AlignedEmbedding',
    ...
    model = SpaDiffusion_Aligner(network_architecture=[graph_data.x.shape[1], hidden_dims[0], hidden_dims[1]]).to(device)
